...
import { Sparkles, ArrowRight, BookOpen, Trophy, Zap, Eye, EyeOff, User, Mail, Lock, Check } from 'lucide-react';
...
const Register = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        if (result.success) {
            toast.success('🎉 Welcome to Neetu JEE!');
            navigate('/');
        } else {
    ...
    const benefits = [
        { icon: BookOpen, title: '50,000+ Questions', color: 'from-sky-400 to-blue-500' },
        { icon: Trophy, title: 'NEET & JEE PYQs', color: 'from-purple-400 to-pink-500' },
        { icon: Zap, title: 'AI Performance Insights', color: 'from-amber-400 to-orange-500' },
    ];
        ...
        <div className="min-h-screen flex items-center justify-center p-4 md:p-6 bg-slate-950 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                    ...
                    className="absolute -top-1/2 -left-1/4 w-96 h-96 md:w-[700px] md:h-[700px] bg-gradient-to-br from-sky-500 to-blue-600 rounded-full blur-[120px]"
                />
                <motion.div
                    animate={{
                        scale: [1, 1.3, 1],
                    ...
                    className="absolute -bottom-1/2 -right-1/4 w-96 h-96 md:w-[800px] md:h-[800px] bg-gradient-to-tl from-indigo-600 to-purple-600 rounded-full blur-[120px]"
                />
                <motion.div
                    animate={{
                        scale: [1.2, 1, 1.2],
                    ...
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 md:w-[600px] md:h-[600px] bg-gradient-to-br from-pink-500 to-rose-600 rounded-full blur-[120px]"
                />
            ...
            >
                ...
                >
                    Join the elite circle of future doctors & engineers ✨
                </motion.p>
                ...
                >
                    {benefits.map(({ icon: Icon, title, color }, idx) => (
                        <motion.div
                            key={title}
